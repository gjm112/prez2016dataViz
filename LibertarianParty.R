...
library(mapproj)
library(dplyr)
png("/Users/gregorymatthews/Dropbox/StatsInTheWild/LibertarianParty.png",res=300,units="in",w=20,h=10)
...
prez<-prez[prez$cand=="Gary Johnson",]
...
title("Election 2016: Libertarian Party")


colleg<-rgb(1,1-seq(0,0.2,length=5)/0.2,1,1) 
leg.txt<-paste0(c(round(100*seq(0,0.2,length=5),2)),"%")
